...
export const securityHeaders = helmet({
  contentSecurityPolicy: process.env.NODE_ENV === 'production' ? {
    directives: {
      ...
      scriptSrc: ["'self'", "https://maps.googleapis.com", "https://*.googleapis.com", "https://maps.google.com", "https://*.google.com"],
      connectSrc: ["'self'", "https://maps.googleapis.com", "https://*.googleapis.com", "https://maps.google.com", "https://*.google.com", "https://api.whatsapp.com"],
