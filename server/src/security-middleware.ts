...
export const securityHeaders = helmet({
  contentSecurityPolicy: process.env.NODE_ENV === 'production' ? {
    directives: {
      ...
      imgSrc: ["'self'", "data:", "https:", "https://maps.gstatic.com", "https://*.googleapis.com"],
      scriptSrc: ["'self'", "https://maps.googleapis.com", "https://*.googleapis.com"],
      connectSrc: ["'self'", "https://maps.googleapis.com", "https://*.googleapis.com", "https://api.whatsapp.com"],
